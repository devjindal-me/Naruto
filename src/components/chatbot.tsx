...
export function Chatbot() {
  ...
  return (
    <div className="flex flex-col h-[60vh]">
      <h2 className="text-3xl font-bold font-headline text-primary mb-4">Chat with Naruto</h2>
      <div className="flex-grow bg-muted/30 rounded-lg border p-4 flex flex-col">
          ...
          <div className="space-y-6">
            ...
            {isLoading && (
              <div className="flex items-start gap-3 justify-start">
                ...
                <div className="p-3 rounded-lg bg-background flex items-center space-x-2">
